...
var Config = (function () {
    function Config() {
        ...
        this.tokenRootSignIn = null;
        this.tokenRootSignUp = null;
...
var AuthProvider = (function () {
    ...
    Object.defineProperty(AuthProvider.prototype, "tokenRootSignIn", {
        get: function () { return this.SatellizerConfig.tokenRootSignIn; },
        set: function (value) { this.SatellizerConfig.tokenRootSignIn = value; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AuthProvider.prototype, "tokenRootSignUp", {
        get: function () { return this.SatellizerConfig.tokenRootSignUp; },
        set: function (value) { this.SatellizerConfig.tokenRootSignUp = value; },
        enumerable: true,
        configurable: true
    });
...
var Shared = (function () {
    ...
    Shared.prototype.setToken = function (response) {
        var tokenRootSignIn = this.SatellizerConfig.tokenRootSignIn;
        var tokenRootSignUp = this.SatellizerConfig.tokenRootSignUp;
        ...
        if (!token && response) {
            var tokenRootData = tokenRootSignIn && tokenRootSignIn.split('.').reduce(function (o, x) { return o[x]; }, response.data);
            token = tokenRootData ? tokenRootData[tokenName] : response.data && response.data[tokenName];
        }
        if (!token && response) {
            var tokenRootData = tokenRootSignUp && tokenRootSignUp.split('.').reduce(function (o, x) { return o[x]; }, response.data);
            token = tokenRootData ? tokenRootData[tokenName] : response.data && response.data[tokenName];
        }
        if (token) {
